...
$(document).ready(function () {
    ...
    new Vue({
        ...
        methods: {
            ...
            closeProfile: function closeProfile(id) {
                this.openProfiles.splice(this.profileIndex(id), 1);
            },

            profileIndex: function profileIndex(id) {
                for (var i = 0; i < this.openProfiles.length; i++) if (this.openProfiles[i].id == id) return i;
...
},{"./components/billboard.template.html":29,"./components/chat":32,"./components/equip":34,"./components/health":36,"./components/map":38,"./components/profile":40,"./components/sites":42,"./components/teams":44,"./draggable":46,"vue":28,"vue-resource":16,"vue-validator":27}],2:[function(require,module,exports){
...
},{"./character.template.html":31}],31:[function(require,module,exports){
module.exports = '<div v-show="loaded" v-on:click="openProfile" class="character">\n    <div v-el:character class="human" :style=\'style\'>\n        <span v-show="message" class="message"><span>{{ message }}</span></span>\n        <span class="name"><span :class="{\'highlight\': mine}">{{ name }}</span></span>\n    </div>\n</div>\n';
...
},{"./chat.template.html":33}],33:[function(require,module,exports){
module.exports = '<div class="messages">\n    <div class="wrap" v-el:messages>\n        <div class="message" v-for="m in messages[channel]">\n            <span><a href="#" v-on:click="openProfile($event, name, id)">{{ m.name }}</a>:</span>{{ m.text }}\n        </div>\n    </div>\n</div>\n<ul class="channel-picker">\n    <li v-for="c in channels" v-on:click="toggleChannel(c)" :class="{\'current\': currentChannel(c), \'unseen\': unseen[c]}">\n        {{ c | capitalize }}\n    </li>\n</ul>\n<div class="chat-menu">\n    <div class="form">\n        <input placeholder="Your message" type="text" class="message" v-on:keyup="sendMessage($event)" v-model="message"/>\n    </div>\n    <div class="send" v-on:click="sendMessage">Send</div>\n</div>\n';
...
},{"./equip.template.html":35}],35:[function(require,module,exports){
module.exports = '<div style="background: red; width: 300px;"><span data-draggable="draggable">Hello</span></div>\n';
...
},{"./health.template.html":37}],37:[function(require,module,exports){
module.exports = '<div class="health-wrapper">\n    <div class="health">\n        <div class="in" :style="{width: width + \'%\'}">{{ health }}%</div>\n    </div>\n    <div class="assign">Health Usage</div>\n</div>\n';
...
module.exports = {
    ...
    validators: {
        ...
        minLength: function minLength(val, rule) {
            return val.length >= rule;
        }
    },

    computed: {
        noSites: function noSites() {
    ...
    methods: {
        toggleSite: function toggleSite(e, site) {
            e.preventDefault();
        ...
        deleteSite: function deleteSite(e, site) {
            e.preventDefault();
            this['delete'] = site;
        },
...
module.exports = {
    ...
    methods: {
        ...
        openProfile: function openProfile(event, user) {
            event.preventDefault();
