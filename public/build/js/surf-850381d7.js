...
},{"./components/billboard.template.html":81,"./components/chat":84,"./components/map":86,"./components/sites":88,"./components/teams":90,"vue":79,"vue-resource":4,"vue-validator":11}],2:[function(require,module,exports){
...
module.exports = {
    ...
    attached: function attached() {
        ...
        this.$http.get('/api/map').then(function (site) {
            self.processSite(site);
        });
...
module.exports = {
    ...
    methods: {
        ...
        confirmAdd: function confirmAdd() {
            ...
            this.$http.post('/api/sites/new', { 'name': this.newSite.name, 'url': this.newSite.url }).then(function (site) {
    ...
    ready: function ready() {
        ...
        this.$http.get('/api/sites').then(function (sites) {
...
module.exports = {
    ...
    methods: {
        openTeam: function openTeam(e, team) {
            ...
            this.$http.get('/api/teams/' + team.id).then(function (data) {
        ...
        confirmCreate: function confirmCreate() {
            ...
            this.$http.post('/api/teams/new', { 'name': this.newTeam.name, 'description': this.newTeam.description }).then(function (site) {
    ...
    ready: function ready() {
        ...
        this.$http.get('/api/teams').then(function (data) {
